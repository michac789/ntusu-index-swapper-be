...
class TestExamScraper(APITestCase):
    ...
    def create_course_code(self, code):
        return CourseCode.objects.create(code=code, name='sample', academic_units=4, common_schedule='O' * 192)
    ...
    def test_exam_scraper_1(self):
        ...
        course_1 = CourseCode.objects.get(code='AC2101')
        self.assertEqual(
        ...
        course_2 = CourseCode.objects.get(code='BA3203')
        self.assertEqual(
        ...
        course_3 = CourseCode.objects.get(code='BF3204')
        self.assertEqual(
    ...
    def test_exam_scraper_2(self):
        ...
        save_exam_schedule(data)
        course_1 = CourseCode.objects.get(code='PH4608')
        self.assertEqual(
            course_1.exam_schedule,
        ...
        course_2 = CourseCode.objects.get(code='SU2001')
        self.assertEqual(
            course_2.exam_schedule,
